...
export function IconCart(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      <path d="M3 3h2l3.6 7.59a2 2 0 0 0 1.8 1.18H17a2 2 0 0 0 2-1.64l1-5.36H6" strokeLinecap="round" strokeLinejoin="round" />
...
export function IconKey(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      ...
      <path d="M11 12h7l2 2-2 2-2-2h-2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconPeso(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export function IconDineIn(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      <path d="M4 20h16" strokeLinecap="round" />
      <path d="M8 14v-6a2 2 0 1 1 4 0v6" />
...
export function IconTakeout(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      <path d="M6 8l3-4h6l3 4" strokeLinecap="round" />
...
export function IconGCash(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
...
export function IconCOD(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      <path d="M3 7h11v8H3z" />
      <path d="M14 11h4l3 4v0H14z" />
...
export function IconCash(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      ...
      <path d="M7 9h0M17 15h0" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconUsers(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      ...
      <path d="M2 20c0-3.5 3.5-5 6-5" strokeLinecap="round" />
      <path d="M12 20c0-3.5 3.5-5 6-5" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconSettings(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      <circle cx="12" cy="12" r="3" />
      <path d="M19.4 12a7.4 7.4 0 0 0-.2-2l2-1.5-2-3.5-2.3.6a7.4 7.4 0 0 0-1.7-1L12 2 10.8 4a7.4 7.4 0 0 0-1.7 1L6.8 4.5 4.8 8l2 1.5a7.4 7.4 0 0 0-.2 2l-2 1.5 2 3.5 2.3-.6a7.4 7.4 0 0 0 1.7 1L12 22l1.2-2a7.4 7.4 0 0 0 1.7-1l2.3.6 2-3.5-2-1.5z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconPhone(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      <path d="M3 5a2 2 0 0 1 2-2h3l2 4-2 2a12 12 0 0 0 6 6l2-2 4 2v3a2 2 0 0 1-2 2h-1a16 16 0 0 1-14-14z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconMapPin(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      <path d="M12 21s-7-5.33-7-11a7 7 0 1 1 14 0c0 5.67-7 11-7 11z" strokeLinecap="round" strokeLinejoin="round" />
