 ...
 export function NewPasswordClient() {
   ...
   return (
     <section aria-labelledby="newpwd-title" className="relative h-[100dvh] overflow-hidden">
           ...
           >
             ...
             >
               <div className="text-center">
                 <h1 id="newpwd-title" className="font-display text-2xl md:text-3xl font-bold tracking-tight">Set New Password</h1>
                 <p className="mt-2 text-sm opacity-80">Choose a strong password and confirm it.</p>
               </div>

               <form className="mt-4 space-y-4" onSubmit={onSubmit} aria-describedby={errorMsg ? "newpwd-error" : undefined}>
                 <div>
                   <label htmlFor="new-password" className="block text-sm opacity-80 mb-1">New Password</label>
                   <div className="relative">
                     <input
                       id="new-password"
                       type={show1 ? "text" : "password"}
                       className="w-full glass rounded-xl px-3 py-2 pr-12 border border-white/10 focus:ring-2 focus:ring-primary/50 outline-none"
                     ...
                     <motion.button
                       ...
                       className="absolute inset-y-0 right-2 flex items-center p-1 rounded-md hover:bg-white/5"
                     >
                 ...
                 <div>
                   <label htmlFor="new-password-2" className="block text-sm opacity-80 mb-1">Re-enter New Password</label>
                   <div className="relative">
                     <input
                       id="new-password-2"
                 ...
                 {status === "success" ? (
                   <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-sm text-green-500">
                 ...
                 <motion.button
                   ...
                   disabled={!canSubmit}
                   className="mt-2 w-full rounded-xl bg-primary text-primary-foreground px-4 py-3 inline-flex items-center justify-center disabled:opacity-60"
                 >
