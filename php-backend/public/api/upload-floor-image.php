...
$filename = uniqid('floor_') . '_' . time() . '.' . $extension;
$uploadDir = __DIR__ . '/../uploads/floor_layouts/';
$targetPath = $uploadDir . $filename;
$publicUrl = "http://localhost/bistroflow/bistroflow/php-backend/public/uploads/floor_layouts/" . $filename;
